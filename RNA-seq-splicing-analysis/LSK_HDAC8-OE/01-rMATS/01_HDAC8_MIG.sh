#!/bin/bash
#SBATCH --job-name=HDAC8_MIG
#SBATCH -n 6
#SBATCH -N 1-1
#SBATCH -p all
#SBATCH --mem=60G
#SBATCH --time=24:00:00
#SBATCH --output=./HDAC8_MIG.log
#SBATCH --error=./HDAC8_MIG.err

params_dir_ref="$(pwd)"
current_project=./HDAC8_MIG
current_project_output=./HDAC8_MIG/1
gtf=./refFlat_gene_mm10_200213.gtf

singularity exec --bind ${params_dir_ref} /opt/rMATS/4.1.2.simg python /rmats/rmats.py \
 --b1 ./lnk/MIG_b1_NIR.txt \
 --b2 ./lnk/MIG_b2_IR.txt \
