...
#SBATCH --output=./MV4CD531.log
#SBATCH --error=./MV4CD531.err

params_dir_ref="$(pwd)"
current_project=./1_MV4CD531
current_project_output=./1_MV4CD531/output
gtf=./genome.gtf

singularity exec --bind ${params_dir_ref} /opt/rMATS/4.1.2.simg python /rmats/rmats.py \
 --b1 ./lnk/MV4CD531_b1_NIR.txt \
 --b2 ./lnk/MV4CD531_b2_IR.txt \
